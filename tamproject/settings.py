...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "shopcart.up.railway.app"]
CSRF_HOSTS = ['shopcart.up.railway.app']
...
WSGI_APPLICATION = 'tamproject.wsgi.application'
